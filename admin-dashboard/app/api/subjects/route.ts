...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { name, name_my, grade_levels, full_marks, pass_marks, school_id } = body;
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    const allowedFields = ['name', 'name_my', 'grade_levels', 'full_marks', 'pass_marks', 'display_order', 'is_active'];
