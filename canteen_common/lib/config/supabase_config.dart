...
///
/// Holds Supabase project credentials. These should be set before
/// calling Supabase.initialize() in main.dart.
class SupabaseConfig {
  ...
  /// Supabase anonymous/public key (safe to include — RLS protects data)
